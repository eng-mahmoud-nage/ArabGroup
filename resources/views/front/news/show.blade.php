    ...
    <div class="row">
        ...
        <div class=""   style="width: 75%">
          <div class="col-md-12 col-sm-12 inspire-form-bg">
                                  ...
                                  <ul class="thumbnails">
                                  <li><a class="thumbnail" href="{{asset('/uploads').'/'.$record->images()->first('source')['source']}}" title="{{$record->name}}">
                                       <img data-zoom-image="{{asset('/uploads').'/'.$record->images()->first('source')['source']}}" src="{{asset('/uploads/thumbs').'/'.$record->images()->first('source')['source']}}" id="inspzoom" class="img-responsive center-block" alt="image">
                                  </a>
                              </li>
                                                                                      <div class="row">
                              <li id="additional" class="owl-carousel">
                                  @foreach ($record->images()->all() as $image)
                                      
                                  @endforeach
                                
                                      <a data-zoom-image="{{asset('/uploads').'/'.$image->source}}" data-image="{{asset('/uploads').'/'.$image->source}}"  href="{{asset('/uploads').'/'.$image->source}}">
                                      <img src="{{asset('/uploads/thumbs').'/'.$image->source}}" class="img-responsive center-block col-xs-12" alt="additional image">
                                  </a>
