...
@extends('front.index')
@section('content')
<div id="checkout-cart" class="container" style="width:75%; float:left">
    {{-- <ul class="breadcrumb">
        ...
        <form action="http://templatetasarim.com/opencart/Books/index.php?route=checkout/cart/edit" method="post" enctype="multipart/form-data">
            ...
            <table class="table table-bordered">
              ...
              <tbody>
                @forelse ($records as $item)
                  ...
                  <small>Reward Points: 400</small>                 </td>
                  <td class="" style="word-wrap: break-word;">
                    {!!App\Book::where('id', $item->book_id)->pluck('name')[0]!!}
                            </td>
                <td class="text-left"><div class="input-group btn-block" style="max-width: 200px;">
                    <input type="text" name="quantity[23]" value="{{$item->quantity}}" size="1" class="form-control" />
                    <span class="input-group-btn">
                    <button type="submit" data-toggle="tooltip" title="Update" class="btn btn-primary cartbt"><i class="fa fa-refresh"></i></button>
                    <button type="button" data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="RemoveItem({{$item->id}})"><i class="fa fa-times-circle"></i></button>
                    </span></div></td>
        ...
        <div class="row">
          <div class="col-sm-4 col-sm-offset-8">
            <table class="table table-bordered">
                ...
                <td class="text-right">$1,199.00</td>
              </tr>
                          <tr>
                ...
                <td class="text-right">$1,241.00</td>
              </tr>
                        </table>
          </div>
        </div>
        <div class="buttons clearfix">
          <div class="pull-left"><a href="http://templatetasarim.com/opencart/Books/index.php?route=common/home" class="btn btn-default">Continue Shopping</a></div>
          <div class="pull-right"><a href="http://templatetasarim.com/opencart/Books/index.php?route=checkout/checkout" class="btn btn-primary">Checkout</a></div>
        </div>
      </div>
        </div>
      </div>
